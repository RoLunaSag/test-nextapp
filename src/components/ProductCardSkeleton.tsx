export default function ProductCardSkeleton() {
    return (
        <div className="flex-row border-2 border-gray-300 rounded-lg p-4 m-4 bg-white animate-pulse w-64">
            <div className="bg-gray-200 h-28 w-28 rounded mb-4 mx-auto" />
