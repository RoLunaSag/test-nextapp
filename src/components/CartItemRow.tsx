    ...
    return (
        <div className="flex items-center gap-4 border-b border-gray-300 py-4">
            ...
            <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-red-600">${product.price.toFixed(2)} c/u</p>
            </div>
            <div className="flex items-center gap-2">
                <button
                    onClick={onDecrement}
                    className="px-3 py-1 bg-gray-800 rounded hover:bg-gray-300"
                >
                    -
                </button>
            ...
            <div className="w-20 text-right font-semibold text-pink-700">
